...
# from models.test5 import BiSRNet as Net
# from models.SSCDl import SSCDl as Net
DATA_NAME = 'ST'
#################################
...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--chkpt_path', required=False, default=working_path+R'')
...
def predict(net, pred_set, pred_loader, pred_dir, flip=False, index_map=False, intermediate=False):
    ...
    for vi, data in enumerate(pred_loader):  #pred_loader就是test_loader
        imgs_A, imgs_B = data
