...
class ResBlock(nn.Module):  #残差块
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.downsample = downsample   #跳跃连接,由downsample进行通道改变
        self.stride = stride
...
class BiSRNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=7):
        ...
        self.resCD = self._make_layer(ResBlock, 256, 128, 6, stride=1)        #上一个输出C=256/
